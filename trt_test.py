...
# code borrowed from https://pytorch.org/TensorRT/_notebooks/Resnet50-example.html
...
benchmark(model, input_shape=(128, 3, 224, 224), nruns=2)
...
torch.jit.save(trt_model_fp32, "trt_model_fp32.ts")
...
trt_ts_module = torch.jit.load("trt_model_fp16.ts")
benchmark(trt_ts_module, input_shape=(128, 3, 224, 224), dtype='fp16', nruns=100)
